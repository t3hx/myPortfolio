...
- The reveal groups are **not** sections: the CV holds four (header, experience, skills, traits) spanning three screens, each with its own observer. Nesting them under one `data-revealed` would light the cards three screens early.
